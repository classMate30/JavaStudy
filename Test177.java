...
○  Serializable 인터페이스
	...
	JVM에 알려주는 역할을 수행한다  (Serializable만 보더라도 JVM은 직렬화가 필요하다는 것을 앎)
	또한, Serializable 인터페이스는
	다른 인터페이스와 달리 구현해야할 메소드가 없기 때문에 
	단지 선언만 해주면 된다.
...
○  Object Stream
	...
	즉, Serializable 인터페이스와 Externalizable인터페이스를 
...
public class Test177
{
	public static void main(String[] args) throws IOException, ClassNotFoundException
	{
		...
		//		밑에 구문 참조 / 구조적으로 동일한 구문
		//BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		

		//※  ObjectOutptStream 클래스는
		...
		//객체 전용 리소스 반납		//리소스 반납할때는 생성된 순서와 반대
		oos.close();
		...
		{	
			...
			// ★여기선 Enumeration만 가능하고 Iterator는 안됨! ★
