...
public class AdminMode implements Mode
{
	...
	//객체가 하나로 관리 해야하기때문에 다른객체가 생성되지 않게 하기 위해 한 데이터를 소지하기 위해
	//만들기 위해서 관리자에서 하나를 생성하고, 그 다음에 객체를 떠넘기는 형식으로 하는 것
	...
	public void stockUp() throws IOException {
		...
		do{
			...
			if (itemId > 0 && itemId <= 15) {
				...
				System.out.println(vendingmachine.getName(itemId-1) + "이 5개 추가되었습니다.");
			} else {
