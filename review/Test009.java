...
public class Test009
{
	public static void main(String[] args)
	{
		...
		//double a=0, 0은 더블형으로 자동 형변환 됨 그래서 a의결과는 0.0이 나옴
		System.out.println("doulbe a : " +a);
		//--==>>double a :0.0
		...
		나눗셈의 연산순위보다 ()의 연산순위가 더 높기에 
		double b= 1.0/2;이라고 봐야함
		그러므로 답은 double b:0.5가 되는것
		*/
		
		double c = 1/2+1/2;
		System.out.println("double c : " +c);

		//피연산자로 실수가 포함되어 있는 나눗셈 연산
		double d = 1/2.0;
		System.out.println("double d : " +d);
		//--==>> double d : 0.5
		/*나눗셈의 연산과 관련하여 
		피연산자 중에 실수가 하나라도 포함되어 있으면
		연산은 실수 기반의 연산이 수행되며
		결과값 또한 실수 형태로 반환된다
		*/
