...
○  Enumeration과 Iterator 인터페이스
	...
	-java.util.Iterator<E> 인터페이스
	 : Enumeration 과의 차이점은 단지 『remove()』메소드가 추가된 것 뿐이다
	   ...
	   Enumeration 인터페이슨느 집합 내에서 요소를 제거할 방법이 없기 때문에
...
public class Test164
{
	public static void main(String[] args)
	{
		...
		//	  - hasMoreElements()
		//	  - nextElement()
		Enumeration<String> e = v.elements();		//리턴 타입이 Enumeration 타입임
		...
		*/
		...
		//	  - hasNext()
		//	  - next()
		Iterator<String> it = v.iterator();			//데이터를 받아낼때 이터레이터 타입으로 받아내면됨
