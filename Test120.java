...
{	
	...
	//ADemo의 write(); 와 BDemo의 print();를 상속 받은 상태임
	public void test();
}
...
//클래스의 입장에선 abstract는 객체를 생성할 수 없게 하는 낙인과 같은 존재이므로 항상 유의 할것
//메소드 오버라이딩을 통해서 변경
//  ↓
//클래스
//두 인터페이스(ADemo, BDemo)를 상속받은 인터페이스(CDemo)를 구현한 후
//모든 메소드를 재정의 함 → (abstract)제거 가능 → 객체 생성 가능
/*
