...
public class Sungjuk_1
{
	// 주요 속성 구성
	int inwon;			//-- 인원 수
	Record_1[] rec;		//-- Record 배열(학생 한 명 당 Record 배열 방 한개 활용)
	...
	public void set()
	{
		...
		// check~!! 
		// ★빈 그릇을 만들겠다는거지, 실제 객체들이 담겨있는것이 아니다★
		// Record_1 클래스를 기반으로 생성된 객체(인스턴스)를 담을 수 있는
		// 배열방을 inwon만큼 생성한것이지
		// Record_1클래스의 인스턴스를 생성한 것이 아니다.
