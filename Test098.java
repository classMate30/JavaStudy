/*==================================================================================
   ■■■ 클래스와 인스턴스 ■■■
   - 정보 은닉과 접근 제어 지시자(접근 지시자, 접근제어자, 접근 지정자, 접근 제한자)
====================================================================================*/
import java.util.Scanner;

class CircleTest2
{
	// 멤버 변수(CircleTest2의 멤버변수) , 인스턴스 변수 , 전역 변수
	//int num;
...
public class Test098
{
	public static void main(String[] args)
	{
		...
		ob1.input();
		//--==>> 반지름 입력 : 500
		//		 → 『ob1.num = 500;』이런뜻이지만 private으로 외부에서 직접 변경하지 못하게 막아놨음
