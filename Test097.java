...
{
	public static void main(String[] args) //문자열 배열의 이름을 args라고 지은것
	{
	...
	public static int[] copyArray(int[] os)
	{
		...
		for (int i=0; i<os.length; i++)	//i<result.length가능
		{
			result[i] = os[i];
		}
...
/*
    10 20000    30    40    50		배열 원본
    10 20000    30    40    50		얕은 복사
    10    20    30    40    50		깊은 복사
    10    20    30    40    50		깊은 복사
계속하려면 아무 키나 누르십시오 . . .
*/
